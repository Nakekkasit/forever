...
const Navbar = () => {
  ...
  function handleSearchClick() {
    if (location.pathname.includes("collection")) setShowSearch(!showSearch);
    else {
      setShowSearch(true);
      navigate("/collection");
    }
    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center bg-black leading-4 text-white aspect-square rounded-full text-[8px]">
            {getCartCount()}
          </p>
        </Link>
        <img
